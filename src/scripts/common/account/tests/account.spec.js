...
describe('account tests', function(){
  ...
  var $httpBackend, $rootScope, notifications, securityAuthorization;
  ...
  // it('should access account page and submit edit', inject(['$controller', 'I18N.MESSAGES', 'security', '$state', function ($controller, i18nMessages, security, $state){
  ...
  //   var $scope = $rootScope.$new();
  //   var providers = [{provider: 'facebook', first: 'Face', last: 'Test', profileId: '1', _id: '1234'}, {provider: 'google', first: 'Goog', last: 'Test', profileId: '2', _id: '5432'}];
  //   $httpBackend.when('GET', '/api/account/linkedAccounts').respond(200, providers);
  ...
  it('should delete Account Tokens', inject(['$controller', 'I18N.MESSAGES', function ($controller, i18nMessages){
    var $scope = $rootScope.$new();
    var cookies = [{autoIndexSeries: 'a', token: '1', _id:'1234'}, {autoIndexSeries: 'b', token: '2', _id: '5432'}];
    $httpBackend.when('GET', '/api/account/security').respond(200, cookies);
